...
public class Blackjack {
    ...
    public static void crearMano(List<String> mazo) {
        ...
        System.out.println();
        puntaje = contarPuntaje(manoJugador);

        if (puntaje == 20 || puntaje == 21) {
            System.out.println("Tiene un puntaje de " + puntaje + " quiere hacer split? \n[1] Si \n[2] No");
            op = teclado.nextInt();
            if (op == 1) {
                jugarConSeparadas(manoJugador);
            } else if (op == 2) {
    ...
    public static List<String> PartirMano(List<String> manoJugador) {
        List<String> mano1 = new ArrayList<>();
        mano1.add(manoJugador.get(1));
        manoJugador.remove(1);
        return mano1;

    }

    public static void pedirCartaSplit(List<String> mazo, List<String> mano, List<String> mano2) {
        Scanner teclado = new Scanner(System.in);
        int elec, puntaje1 = 0, puntaje2 = 0;

        do {
            puntaje1 = contarPuntaje(mano);
            System.out.println("Quiere pedir otra carta? Actualmente en su primer split:");
            mostrarMano(mano);
            ...
            do {
                puntaje2 = contarPuntaje(mano2);
                System.out.println("Quiere pedir otra carta? Actualmente en su segundo split:");
                mostrarMano(mano);
                System.out.println(puntaje1);
    ...
    public static void jugarConSeparadas (List < String > manoJugador) {
        List<String> manojugador2 = new ArrayList<>();
        manojugador2 = PartirMano(manoJugador);

        System.out.println("Su punaje en las 2 manos son de " + contarPuntaje(manoJugador) + " y " + contarPuntaje(manojugador2));
